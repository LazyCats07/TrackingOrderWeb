...
<div class="container">
    <form id="cekStatusOrder" method="POST">
        <div class="input-group mb-3 searchButton" style="margin-top:20px;">
            <input type="text" class="form-control sm" id="cari" name="cari" placeholder="Masukkan No. Order" required maxlength="10" aria-label="Recipient's username" aria-describedby="button-addon2" oninput="this.value = this.value.replace(/[^0-9-]/g, '').slice(0, 10);">
